            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" id="name" name="name" class="form-control"
                           value="<?php echo $department['department']; ?>" title="You can't edit the sNumber"/>
                </div>
            </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Do you want to delete the
                            department <?php echo($department['department']); ?>?</h4>
                    </div>
